...
export default function CorrectionPreview({ navigation }) {
  ...
  const renderItem = ({ item }) => (
    <ParticipantCard navigation={navigation} answerCardInfo={item} />
  );

  return (
    <Container> 
      <NavigationHeader navigation={navigation} goTo="MakeCorrection" pageTitle="Correção em processo" />
